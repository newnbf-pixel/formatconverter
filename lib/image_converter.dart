...
class ImageConverter {
  /// يحوّل بايتات صورة (أي صيغة مدعومة من package:image) الى الصيغة المطلوبة.
  static Uint8List convert(Uint8List bytes, ImageFormatOption target) {
    ...
    switch (target) {
      ...
      case ImageFormatOption.jpg:
        // JPG لا يدعم الشفافية؛ ندمج الصورة على خلفية بيضاء لتفادي ظهور خلفية سوداء
  ...
  static List<ImageFormatOption> targetsExcluding(String sourceExt) {
    ...
    return all
        .where((f) => f.extension != sourceExt.toLowerCase())
